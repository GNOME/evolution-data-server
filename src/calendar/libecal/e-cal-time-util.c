			   ...
			   const ICalTimezone *zone)
{
	...
	/* Get the weekday. */
	weekday = time_day_of_week (i_cal_timetype_get_day (tt), i_cal_timetype_get_month (tt) - 1, i_cal_timetype_get_year (tt));
			 ...
			 const ICalTimezone *zone)
{
	...
	g_date_set_dmy (date, i_cal_timetype_get_day (tt), i_cal_timetype_get_month (tt), i_cal_timetype_get_year (tt));
...
icaltimetype_to_tm (const ICalTimetype *itt)
{
	...
	tm.tm_wday = time_day_of_week (i_cal_timetype_get_day (tt), i_cal_timetype_get_month (tt) - 1, i_cal_timetype_get_year (tt));
	tm.tm_isdst = -1;
