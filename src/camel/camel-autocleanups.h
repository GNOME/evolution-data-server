/*
 * SPDX-FileCopyrightText: (C) 2019 elementary, Inc. (https://elementary.io)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CamelStoreDB, g_object_unref)
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CamelStoreSearch, g_object_unref)
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CamelStoreSearchIndex, camel_store_search_index_unref)
