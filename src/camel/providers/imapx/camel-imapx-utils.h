...
#define CAMEL_IMAPX_UNTAGGED_ESEARCH    "ESEARCH"
...
enum {
	...
	IMAPX_CAPABILITY_MULTISEARCH = (1 << 21),
	IMAPX_CAPABILITY_IMAP4REV2 = (1 << 22), /* RFC 9051 */
	IMAPX_CAPABILITY_UNSELECT = (1 << 23), /* RFC 3691 / folded into RFC 9051 */
	IMAPX_CAPABILITY_LITERALMINUS = (1 << 24) /* RFC 7888 / folded into RFC 9051 */
};
