      ...
      gchar **argv)
{
	...
	g_test_add_func ("/Camel/CamelStoreSearch/Create", test_store_search_create);
	g_test_add_func ("/Camel/CamelStoreSearch/Subject", test_store_search_subject);
	g_test_add_func ("/Camel/CamelStoreSearch/Addresses", test_store_search_addresses);
	g_test_add_func ("/Camel/CamelStoreSearch/Flags", test_store_search_flags);
	g_test_add_func ("/Camel/CamelStoreSearch/UserTags", test_store_search_user_flags);
	g_test_add_func ("/Camel/CamelStoreSearch/UserFlags", test_store_search_user_tags);
	g_test_add_func ("/Camel/CamelStoreSearch/UID", test_store_search_uid);
	g_test_add_func ("/Camel/CamelStoreSearch/Headers", test_store_search_headers);
	g_test_add_func ("/Camel/CamelStoreSearch/Dates", test_store_search_dates);
	g_test_add_func ("/Camel/CamelStoreSearch/Size", test_store_search_size);
	g_test_add_func ("/Camel/CamelStoreSearch/MessageID", test_store_search_message_id);
	g_test_add_func ("/Camel/CamelStoreSearch/MessageLocation", test_store_search_message_location);
	g_test_add_func ("/Camel/CamelStoreSearch/AddressbookContains", test_store_search_addressbook_contains);
	g_test_add_func ("/Camel/CamelStoreSearch/Body", test_store_search_body);
	g_test_add_func ("/Camel/CamelStoreSearch/Extras", test_store_search_extras);
	g_test_add_func ("/Camel/CamelStoreSearch/Index", test_store_search_index);
	g_test_add_func ("/Camel/CamelStoreSearch/MatchThreads", test_store_search_match_threads);
	g_test_add_func ("/Camel/CamelStoreSearch/MatchThreadsMultipleStores", test_store_search_match_threads_multiple_stores);
	g_test_add_func ("/Camel/CamelStoreSearch/MatchThreadsOnlyLeaves", test_store_search_match_threads_only_leaves);
	g_test_add_func ("/Camel/CamelStoreSearch/Folder", test_store_search_folder);
	g_test_add_func ("/Camel/CamelStoreSearch/FolderMatchThreads", test_store_search_folder_match_threads);
	g_test_add_func ("/Camel/CamelStoreSearch/FolderMatchThreadsOnlyLeaves", test_store_search_folder_match_threads_only_leaves);
	g_test_add_func ("/Camel/CamelStoreSearch/BoolSExp", test_store_search_bool_sexp);
