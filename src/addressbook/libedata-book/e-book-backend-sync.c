				   ...
				   const gchar * const *vcards)
{
	...
	e_book_backend_sync_create_contacts (E_BOOK_BACKEND_SYNC (backend), vcards, &contacts, cancellable, &error);
				   ...
				   const gchar * const *vcards)
{
	...
	e_book_backend_sync_modify_contacts (E_BOOK_BACKEND_SYNC (backend), vcards, &contacts, cancellable, &error);
				   ...
				   const gchar * const *uids)
{
	...
	e_book_backend_sync_remove_contacts (E_BOOK_BACKEND_SYNC (backend), uids, &removed_uids, cancellable, &error);
