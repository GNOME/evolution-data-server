                                     ...
                                     GError **perror)
{
	...
	success = e_book_backend_sqlitedb_lock_updates (bf->priv->sqlitedb, perror);

	if (success)
		success = do_create (bf, vcards, added_contacts, perror);
                                     ...
                                     GError **perror)
{
	...
	if (!e_book_backend_sqlitedb_lock_updates (bf->priv->sqlitedb, perror))
		status = STATUS_ERROR;
