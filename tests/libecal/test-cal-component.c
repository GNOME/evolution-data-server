			    ...
			    ICalTimetype *received)
{
	...
	g_assert_cmpint (i_cal_timetype_get_is_date (expected) ? 1 : 0, ==, i_cal_timetype_get_is_date (received) ? 1 : 0);
	g_assert_cmpint (i_cal_timetype_get_is_daylight (expected) ? 1 : 0, ==, i_cal_timetype_get_is_daylight (received) ? 1 : 0);
...
test_component_struct_alarm (void)
{
	...
	gint ii, nth_description = 0, nth_repeat = 0, nth_trigger = 0, nth_attendees = 0, nth_attachments = 0, nth_properties = 0;
